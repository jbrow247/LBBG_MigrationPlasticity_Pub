...
bp.ol <- ggplot(rand.ol, aes(pair, overlap)) + geom_boxplot() +ylab("Range Overlap") + theme(axis.title.y = element_text(size = 9),  axis.text = element_text(size = 9), axis.title.x = element_blank())
...
bp.tf <- ggplot(rand.t.f, aes(pair, mn_var)) + geom_boxplot()+ylab("Mean autumn route variance (km)") + theme(axis.title.y = element_text(size = 9),  axis.text = element_text(size = 9), axis.title.x = element_blank())
bp.ts <- ggplot(rand.t.s, aes(pair, mn_var)) + geom_boxplot() +ylab("Mean spring route variance (km)") + theme(axis.title.y = element_text(size = 9),  axis.text = element_text(size = 9), axis.title.x = element_blank())
...
```{r Fig. S2, include = T}
png("Figs2.png",  width = 16, height = 5.33, units = "cm", res = 300)
